...
<div class="card">
    ...
    <div style="background:#FFEBEB; color:#D32F2F; padding:10px; border-radius:4px; font-size:12px; margin-bottom:15px; border:1px solid #FFD2D2;">
    ...
    <div class="link-row" style="margin-top:8px;"><a href="${pageContext.request.contextPath}/feed">View Public Feed &rarr;</a></div>
    <div class="link-row" style="margin-top:24px;border-top:1px solid #E8E8ED;padding-top:16px;">Municipality staff? <a href="${pageContext.request.contextPath}/admin/login.jsp">Admin Login &rarr;</a></div>
</div>
</body>
</html>
